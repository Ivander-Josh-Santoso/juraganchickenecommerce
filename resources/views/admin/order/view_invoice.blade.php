...
<body>
	...
	<table width="100%" style="background: #F7F7F7; padding: 0 20px 0 20px;">
		<tr>
			<td valign="top">
				<h2 style="color:blue; font-size: 26px;"><strong>Juragan Chicken</strong></h2>
			</td>
			<td align="right" style="margin-right: 20px;">
				<pre>
					Juragan Chicken Semarang
					Email: juraganchickensemarang@gmail.com <br>
					Phone: 087803112002 <br>
				</pre>
			</td>
		</tr>
	</table>
